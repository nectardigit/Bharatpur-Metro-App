...
class PolicyLawScreen extends StatelessWidget {
  String lawID;

  PolicyLawScreen({Key? key, required this.lawID});
  ...
  Widget build(BuildContext context) {
    List<LawData> constitutionlawFilter =
        controller.lawlist.where((e) => e.lawType == lawID.toString()).toList();
    // var list = controller.lawtypeList;
    return Scaffold(
      appBar: buildAppbar(controller.isNepali.value ? 'कानुन' : ' Law'),
