...
class RuleLawScreen extends StatelessWidget {
  RuleLawScreen({Key? key});
  final controller = Get.put(AppController());
  @override
  Widget build(BuildContext context) {
    List<LawData> constitutionlawFilter =
        controller.lawlist.where((e) => e.lawType == '4').toList();
    // var list = controller.lawtypeList;
    return Scaffold(
      appBar:
          buildAppbar(controller.isNepali.value ? 'नियम कानुन' : ' Rule Law'),
