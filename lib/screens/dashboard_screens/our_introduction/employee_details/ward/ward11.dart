...
class Ward11OfficersScreen extends StatelessWidget {
  Ward11OfficersScreen({
    Key? key,
  });
  ...
  Widget build(BuildContext context) {
    List<TeamData> ward11OfficersScreen = controller.teamlist
        .where((e) => e.office!.en == 'Ward 11 Ward Office')
        .toList();
    return Scaffold(
      backgroundColor: AppColor.backgroundClr,
      appBar: buildAppbar(
        controller.isNepali.value ? '११ वार्ड कार्यालयहरु' : '11 Ward Offices',
      ),
