...
class Ward10OfficersScreen extends StatelessWidget {
  Ward10OfficersScreen({
    Key? key,
  });
  ...
  Widget build(BuildContext context) {
    List<TeamData> ward11OfficersScreen = controller.teamlist
        .where((e) => e.office!.en == 'Ward 10 Ward Office')
        .toList();
    return Scaffold(
      backgroundColor: AppColor.backgroundClr,
      appBar: buildAppbar(
        controller.isNepali.value ? '१० वार्ड कार्यालयहरु' : '10 Ward Offices',
      ),
