...
import 'package:gandakimun/screens/dashboard_screens/our_introduction/officer_details/ward_officer/ward1.dart';
import 'package:gandakimun/widget/appbar.dart';
import 'package:gandakimun/widget/heading.dart';
import 'package:gandakimun/widget/shimmer.dart';
import 'package:get/get.dart';

class WardCommitte extends GetView<AppController> {
  WardCommitte({Key? key}) : super(key: key);
              ...
              ourInformationController.loadingWards.isFalse
                  ? ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return ListTile(
                          onTap: () {
                            Get.to(() => Ward1OfficerDetails(
                                ward: data.title!.en.toString()));
                          },
                          title: Card(
                            child: Padding(
