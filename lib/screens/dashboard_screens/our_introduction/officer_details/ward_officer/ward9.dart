...
class Ward9OfficerDetails extends StatelessWidget {
  Ward9OfficerDetails({
    Key? key,
  });
  ...
  Widget build(BuildContext context) {
    List<ElectedOfficalsData> ward11OfficersScreen = controller.electedOffical
        .where((e) => e.wardNumber!.en == 'Ward 9' && e.isWard == 1)
        .toList();

    return Scaffold(
      backgroundColor: AppColor.backgroundClr,
      appBar: buildAppbar(
        controller.isNepali.value ? '९ नं वडा कार्यालयहरु' : '9 Ward Offices',
      ),
