...
class Ward6OfficerDetails extends StatelessWidget {
  Ward6OfficerDetails({
    Key? key,
  });
  ...
  Widget build(BuildContext context) {
    List<ElectedOfficalsData> ward11OfficersScreen = controller.electedOffical
        .where((e) => e.wardNumber!.en == 'Ward 6' && e.isWard == 1)
        .toList();

    return Scaffold(
      backgroundColor: AppColor.backgroundClr,
      appBar: buildAppbar(
        controller.isNepali.value ? '६ नं वडा कार्यालयहरु' : '6 Ward Offices',
      ),
