...
class Ward11OfficerDetails extends StatelessWidget {
  Ward11OfficerDetails({
    Key? key,
  });
  ...
  Widget build(BuildContext context) {
    List<ElectedOfficalsData> ward11OfficersScreen = controller.electedOffical
        .where((e) => e.wardNumber!.en == 'Ward 11' && e.isWard == 1)
        .toList();

    return Scaffold(
      backgroundColor: AppColor.backgroundClr,
      appBar: buildAppbar(
        controller.isNepali.value ? '११ नं वडा कार्यालयहरु' : '11 Ward Offices',
      ),
