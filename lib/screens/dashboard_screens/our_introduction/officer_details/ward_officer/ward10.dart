...
class Ward10OfficerDetails extends StatelessWidget {
  Ward10OfficerDetails({
    Key? key,
  });
  ...
  Widget build(BuildContext context) {
    List<ElectedOfficalsData> ward11OfficersScreen = controller.electedOffical
        .where((e) => e.wardNumber!.en == 'Ward 10' && e.isWard == 1)
        .toList();

    return Scaffold(
      backgroundColor: AppColor.backgroundClr,
      appBar: buildAppbar(
        controller.isNepali.value ? '१० नं वडा कार्यालयहरु' : '10 Ward Offices',
      ),
